...
const LEVEL_ONE = [
    { x: 0, y: 30, type: "wall-cross"},
    { x: 24, y: 30, type: "wall-horz", num: 27},
    { x: 696, y: 30, type: "wall-cross" },
    { x: 0, y: 52, type: "wall-vert", num: 23},
    { x: 0, y: 628, type: "wall-cross"},
    { x: 24, y: 628, type: "wall-horz", num: 27 },
    { x: 696, y: 628, type: "wall-cross" },
    { x: 696, y: 126, type: "wall-vert", num: 23 },
    { x: 552, y: 162, type: "wall-vert", num: 2 },
    { x: 552, y: 138, type: "wall-cross"},
    { x: 360, y: 390, type: "wall-horz", num: 10 },
    { x: 312, y: 468, type: "wall-vert", num: 4 },
    { x: 112, y: 162, type: "wall-vert", num: 7 },
    { x: 132, y: 138, type: "wall-horz", num: 4 },
    { x: 250, y: 138, type: "wall-cross"},
    { x: 250, y: 162, type: "wall-vert", num: 1 },
    { x: 144, y: 390, type: "wall-horz", num: 9 },
    { x: 336, y: 468, type: "wall-horz", num: 4 },
    { x: 312, y: 468, type: "wall-cross" },
    { x: 384, y: 138, type: "wall-horz", num: 6 },
    { x: 112, y: 138, type: "wall-cross"},
...
const LEVEL_ONE_EXIT = Object.freeze({0: 610, 1: 50});
