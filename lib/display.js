...
const LEVEL_ONE = [
    ...
    { x: 552, y: 126, type: "wall-vert" },
    { x: 552, y: 170, type: "wall-vert", num: 2 },
    { x: 552, y: 150, type: "wall-cross"},
    { x: 360, y: 390, type: "wall-horz", num: 10 },
    { x: 312, y: 468, type: "wall-vert", num: 4 },
    { x: 72, y: 150, type: "wall-vert", num: 8 },
    { x: 96, y: 150, type: "wall-horz", num: 4 },
    { x: 192, y: 150, type: "wall-horz", num: 2 },
    { x: 144, y: 390, type: "wall-horz", num: 9 },
    { x: 336, y: 468, type: "wall-horz", num: 4 },
    { x: 312, y: 468, type: "wall-cross" },
    { x: 384, y: 150, type: "wall-horz", num: 6 },
    { x: 72, y: 150, type: "wall-cross"},
